...
APP_VERSION='1.0.0'
APP_DESCRIPTION='Analyze resumes with job descriptions using ML+NLP techniques and provide insights for improving the resume.'

ALLOWED_ORIGINS = [
    "http://localhost:5173", # Vite server for react
    "http://localhost:3000", # React app fallback
    "http://127.0.0.1:5173"
]
